...
public class UserTest {
    ...
    class SuccessTests {
        ...
        void testRegisterMemberSuccess() {
            ...
            User user = new User("test.test@gmail.com", "Azerty1!", Role.USER);
        ...
        void testRegisterAdminSuccess() {
            User user = new User("test.test@gmail.com", "Azerty1!", Role.ADMIN);
    ...
    class FailureTests {
        ...
        void testInvalidEmail() {
            ...
            IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () ->
                    new User("sdfsdfsdf@sdfsdf", "Azerty1!", Role.USER)
            );
        ...
        void testWeakPasswords(String password, Role role, String scenario) {
            ...
            IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () ->
                    new User("sdfsdfsdf@sdfsdf.com", password, role)
            );
        ...
        void testNullRole() {
            ...
            IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () ->
                    new User("sdfsdfsdf@sdfsdf.com", "Azerty1!", null)
            );
